...
<body>
  ...
  <section id="feature-products" class="py-8 px-20 mt-5">
    ...
    <div class="flex justify-between py-5 flex-wrap">
        ...
        <img src="http://localhost/DarkDevilsLiteFashion/user/layout/images/products/<?php echo $men->P_image1; ?>" alt="" />
  ...
  <section id="feature-products" class="py-8 px-20 mt-5">
    ...
    <div class="flex justify-between py-5 flex-wrap">
        ...
        <img src="http://localhost/DarkDevilsLiteFashion/user/layout/images/products/<?php echo $women->P_image1; ?>" alt="" />
        <div class="flex justify-between py-3 relative">
          <div class="px-2">
            <span class="text-lg text-slate-500">adidas</span>
  ...
  <section id="feature-products" class="py-8 px-20 mt-5">
    ...
    <div class="flex justify-between py-5 flex-wrap">
        ...
        <img src="http://localhost/DarkDevilsLiteFashion/user/layout/images/products/<?php echo $kids->P_image1; ?>" alt="" />
        <div class="flex justify-between py-3 relative">
          <div class="px-2">
            <span class="text-lg text-slate-500">adidas</span>
