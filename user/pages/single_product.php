...
<body>
  ...
  <section id="product-details" class="py-8 px-40 mt-5 flex">
    <div class="w-[40%] mr-12">
      <img
        src="http://localhost/DarkDevilsLiteFashion/user/layout/images/products/<?php echo $oneClothData->P_image1; ?>"
        width="100%"
        class="mb-1"
        id="main-image" />
      <div class="flex justify-between gap-1">
        ...
        <img
          src="http://localhost/DarkDevilsLiteFashion/user/layout/images/products/<?php echo $oneClothData->P_image2; ?>"
          width="100%"
          class="cursor-pointer small-image" />

        <img
          src="http://localhost/DarkDevilsLiteFashion/user/layout/images/products/<?php echo $oneClothData->P_image3; ?>"
          width="100%"
          class="cursor-pointer small-image" />

        <img
          src="http://localhost/DarkDevilsLiteFashion/user/layout/images/products/<?php echo $oneClothData->P_image4; ?>"
          width="100%"
          class="cursor-pointer small-image" />
      </div>
    </div>
  ...
  <section id="feature-products" class="py-8 px-20 mt-5">
    ...
    <?php foreach($allReletedCloth as $reletedCloth) : ?>
      <div
        ...
        <img src="http://localhost/DarkDevilsLiteFashion/user/layout/images/products/<?php echo $reletedCloth->P_image1; ?>" alt="" />
